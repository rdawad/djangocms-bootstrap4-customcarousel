...
# Imports for custom carousel, added from github
# https://github.com/django-cms/djangocms-bootstrap4/blob/master/djangocms_bootstrap4/contrib/bootstrap4_carousel/models.py
...
class Testing(CMSPlugin):
    name = models.CharField(max_length=200)


class CustomBootstrap4Carousel(CMSPlugin):
    """
...
class CustomBootstrap4CarouselSlide(AbstractLink):
    """
